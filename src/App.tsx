        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="font-extrabold text-slate-950 text-base tracking-tight block">B3 Investimentos</span>
      ...
      <footer id="app-footer" className="bg-white border-t border-slate-100 py-6 mt-12 text-xs text-slate-400 text-center font-medium">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span>© 25-26 B3 Investimentos - Gerenciamento de Patrimônio e IRPF.</span>
          </div>
